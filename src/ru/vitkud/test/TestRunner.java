...
public class TestRunner implements ITestListener {
	...
	protected MenuItem mntmSelectAll;
	protected MenuItem mntmDeselectAll;
	protected MenuItem mntmSelectFailed;
	protected MenuItem mntmSelectCurrent;
	protected MenuItem mntmDeselectCurrent;
	protected MenuItem mntmHideTestNodes;
	protected MenuItem mntmExpandAll;
	protected MenuItem mntmCopyTestnameToClipboard;
	protected MenuItem mntmRunSelectedTest;
	protected MenuItem mntmAutoSave;
	protected MenuItem mntmErrorBoxVisible;
	protected MenuItem mntmHideTestNodesOnOpen;
	protected MenuItem mntmShowTestedNode;
	protected MenuItem mntmBreakOnFailures;
	protected MenuItem mntmUseRegistry;
	protected MenuItem mntmWarnIfFailTestOverridden;
	protected MenuItem mntmFailTestCaseIfNoChecksExecuted;
	protected MenuItem mntmReportMemoryLeakTypeOnShutdown;
	protected MenuItem mntmFailTestCaseIfMemoryLeaked;
	protected MenuItem mntmIgnoreMemoryLeakInSetUpTearDown;
	protected MenuItem mntmRun;
	protected MenuItem mntmRunSelectedTest2;
	protected MenuItem mntmStop;
	protected MenuItem mntmCopyErrorMessageToClipboard;
	protected ToolItem tltmSelectAll;
	protected ToolItem tltmDeselectAll;
	protected ToolItem tltmSelectFailed;
	protected ToolItem tltmSelectCurrent;
	protected ToolItem tltmDeselectCurrent;
	protected ToolItem tltmRun;
	protected ToolItem tltmRunselectedtest;
	protected ToolItem tltmStop;
	protected SashForm sashForm;
	protected Composite compositeResults;
	protected ProgressBar progressBar;
	protected ProgressBar scoreBar;
	protected Label lblProgressPercent;
	protected Composite compositeErrorBox;
	protected StyledText errorMessageStyledText;
	protected MenuItem pmntmSelectCurrent;
	protected MenuItem pmntmDeselectCurrent;
	protected MenuItem pmntmSelectFailed;
	protected MenuItem pmntmSelectAll;
	protected MenuItem pmntmDeselectAll;
	protected MenuItem pmntmHideTestNodes;
	protected MenuItem pmntmExpandAll;
	protected MenuItem pmntmCopyTestnameToClipboard;
	protected MenuItem pmntmRunSelectedTest;
	protected MenuItem pmntmCopyErrorMessageToClipboard;
